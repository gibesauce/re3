...
enum Config {
	NUMPLAYERS = 1,	// 4 on PS2; 1

	NUMCDIMAGES = 12, // gta3.img extras (not used in PC); 12
	MAX_CDIMAGES = 8, // additional cdimages
	MAX_CDCHANNELS = 5,

	MODELINFOSIZE = 5500,	// 3150 on PS2; 5500
#ifdef VANILLA_DEFINES
	TXDSTORESIZE = 850,
#else
	TXDSTORESIZE = 1024,	// 1024 for XBOX map (850 on PC)
#endif
	EXTRADIRSIZE = 128,
	CUTSCENEDIRSIZE = 512,

	SIMPLEMODELSIZE = 5000,	// 2910 on PS2; 5000
	MLOMODELSIZE = 1,
	MLOINSTANCESIZE = 1,
	TIMEMODELSIZE = 30,
	CLUMPMODELSIZE = 5,
	PEDMODELSIZE = 90,
	VEHICLEMODELSIZE = 120,	// 70 on PS2; 120
	XTRACOMPSMODELSIZE = 2,
	TWODFXSIZE = 2000,	// 1210 on PS2: 2000

	MAXVEHICLESLOADED = 70, // 70 on mobile; 50

	NUMOBJECTINFO = 168, // object.dat (168)

	// Pool sizes
	NUMPTRNODES = 30000,  // 26000 on PS2; 30000
	NUMENTRYINFOS = 5400, // 3200 on PS2; 5400
	NUMPEDS = 140,        // 90 on PS2; 140
	NUMVEHICLES = 110,    // 70 on PS2; 110
	NUMBUILDINGS = 5500,  // 4915 on PS2; 5500
	NUMTREADABLES = 1214,
	NUMOBJECTS = 450,
	NUMDUMMIES = 2802, // 2368 on PS2; 2802
...
#ifdef DISABLE_LOADING_SCREEN	// disuse splash screen
	#undef RANDOMSPLASH
#endif
...
#define RADIO_OFF_TEXT		// "RADIO OFF"
#define PC_MENU
...
// Camera
//#define PS2_CAM_TRANSITION	// old way of transitioning between cam modes (not recomended to use with free cam unless you want to hurt eyes)
...
//#define AUDIO_CACHE // used in the mobile port
